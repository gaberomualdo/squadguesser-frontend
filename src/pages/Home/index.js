  ...
  render() {
    ...
    return (
      <div className='homepage'>
        ...
        <div className='box-section horizontal-list column'>
          <div className='inner'>
            <div className='row'>
              <div>
        ...
        <div className='box-section left-first'>
          <div className='left club-logos'>
            <div className='inner'>
              {this.state.top25Teams.slice(0, 12).map((e, i) => (
        ...
        <div className='box-section horizontal-list column guess-by'>
          <div className='inner'>
            <h1>For Each Squad, Guess By...</h1>
            <div className='row'>
              <div>
                <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
