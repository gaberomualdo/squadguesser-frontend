  ...
  render() {
    ...
    return (
      <div className='homepage'>
        ...
        <div className='box-section horizontal-list column stats' style={{ marginBottom: 0 }}>
          <ResponsiveContainer>
            <div className='inner'>
              <div className='row'>
                <div>
        ...
        <div style={{ backgroundColor: 'var(--darker)', paddingTop: '0.75rem', paddingBottom: '1.5rem' }}>
          <ResponsiveContainer>
            <div className='box-section left-first no-background no-margin'>
